$(document).ready(function() {
    ...
    let url = `http://localhost/decisions/Primary/?ReportId=7108f7e5-1363-11e8-97af-9cb6d0d26d62&Action=api&userid=admin%40decisions.com&password=admin&outputtype=JSON`;
